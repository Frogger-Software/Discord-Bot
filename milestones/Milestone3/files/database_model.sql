...
CREATE TABLE IF NOT EXISTS `FrogXDB`.`Product` (
  ...
  `software` VARCHAR(45) NULL DEFAULT 'Software',
...
-- -----------------------------------------------------
-- Table `FrogXDB`.`Board_Member`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `FrogXDB`.`Board_Member` ;

CREATE TABLE IF NOT EXISTS `FrogXDB`.`Board_Member` (
...
-- -----------------------------------------------------
-- Table `FrogXDB`.`Board_Shares`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `FrogXDB`.`Board_Shares` ;

CREATE TABLE IF NOT EXISTS `FrogXDB`.`Board_Shares` (
  ...
  CONSTRAINT `BOARDSHARES_BOARDMEMBER_FK`
    FOREIGN KEY (`board`)
    REFERENCES `FrogXDB`.`Board_Member` (`board_member_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `FrogXDB`.`Advertisement` (
  ...
  `product` INT UNSIGNED NOT NULL,
  `department` VARCHAR(45) NOT NULL DEFAULT 'Marketing',
...
CREATE TABLE IF NOT EXISTS `FrogXDB`.`Sale` (
  ...
  `product` INT UNSIGNED NOT NULL,
  `department` VARCHAR(45) NOT NULL DEFAULT 'Sales',
  `profit` INT NOT NULL,
  PRIMARY KEY (`sale_id`),
...
-- -----------------------------------------------------
-- Table `FrogXDB`.`Parking_Lot`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `FrogXDB`.`Parking_Lot` ;

CREATE TABLE IF NOT EXISTS `FrogXDB`.`Parking_Lot` (
...
CREATE TABLE IF NOT EXISTS `FrogXDB`.`Parking` (
  ...
  CONSTRAINT `PARKING_PARKINGLOT_FK`
    ...
    REFERENCES `FrogXDB`.`Parking_Lot` (`parking_lot_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
